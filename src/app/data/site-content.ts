...
export const SITE_CONTENT: SiteContent = {
  ...
  quote: {
    ...
    body:
      ' designed to fit your lifestyle. Whether you\u2019re balancing work or family commitments, our programs adapt to your needs, allowing you to study at your own pace from the comfort of your home. Unlock your potential and take the next step towards your future today!',
  },
  ...
  qualificationsNav: {
    ...
    links: [
      { title: 'Financial\nAccounting', ctaLabel: 'Find out more', href: '#financial-accounting' },
      { title: 'Business\nManagement', ctaLabel: 'Find out more', href: '#business-management' },
      { title: 'Office\nAdministration', ctaLabel: 'Find out more', href: '#office-administration' },
      { title: 'Skills\nProgrammes', ctaLabel: 'Find out more', href: '#skills-programmes' },
    ],
  },
