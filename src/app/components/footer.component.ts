      ...
      <div class="container">
        <div class="footer__top">
          ...
          <div class="footer__illustration">
            <img
              [src]="footer.illustrationSrc"
              [alt]="footer.illustrationAlt"
            />
          </div>
        ...
        <div class="footer__bottom">
          <div class="footer__accred-badge">
            <img
              class="footer__accred-logo"
              src="images/ICB-logo.jpg"
              [alt]="footer.accreditationLogoAlt"
            />
          </div>
          <div class="footer__accred">
            <h3 class="footer__accred-heading">
              {{ footer.accreditationHeading }}
            </h3>
  ...
  styles: [
    `
      ...
      .footer__social:focus-visible {
        outline: 3px solid var(--imd-white);
        outline-offset: 2px;
      }
